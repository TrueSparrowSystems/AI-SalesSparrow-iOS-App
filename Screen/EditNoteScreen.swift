...
struct EditNoteScreen : View {
    @EnvironmentObject var noteDetailScreenViewModel : EditNoteScreenViewModel
    ...
    var body: some View {
            ...
            .onReceive(noteDetailScreenViewModel.$currentNote) { newCurrentNote in
                currentNote = newCurrentNote
                initalText = newCurrentNote.text
            }
